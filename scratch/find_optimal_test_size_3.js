...
async function main() {
  ...
  console.log("fee   | amt USDC | quote WETH | minOut WETH | Chainlink floor | Hook accepts?");
  ...
  for (const fee of feeTiers) {
    for (const amt of amounts) {
      ...
      console.log(`${fee.toString().padEnd(5)} | ${amt.toString().padEnd(8)} | ${quote.toString().padEnd(10)} | ${amountOutMin.toString().padEnd(11)} | ${calculatedMin.toString().padEnd(15)} | ${hookAccepts.toString()}`);
    }
  }
}
main();
